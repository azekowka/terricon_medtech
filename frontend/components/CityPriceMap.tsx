  ...
  useEffect(() => {
    ...
    const run = () => {
      ...
      for (const c of cities) {
        ...
        el.className = "price-bubble" + (c.min_price === cheapest ? " pb-best" : "") + (selected === c.slug ? " pb-active" : "");
